document.addEventListener('DOMContentLoaded', function () {
    const projects = [
        ...
        { id: 12, name: 'Club de comunicación', image: 'Club de comunicación.png', description: 'Realizar actividades que potencien las habilidades comunicativas: Círculos de oratoria, debates, improvisación y juegos de rol que permitan al asociado aprender mediante la práctica.', maxInscriptions: 6, currentInscriptions: 0 },
        ...
        { id: 2, name: 'Estrategia Digital', image: 'Estrategia Digital.png', description: 'Crearemos un estrategia de marketing digital para las redes sociales del capítulo y toda su presencia en el social media.', maxInscriptions: 6, currentInscriptions: 0 },
        ...
        { id: 1, name: 'Misión SAIO', image: 'Mision SAIO 1.png', description: 'Investigaremos la planificación y organización del evento abordando la definición de objetivos claros, la segmentación del público, la temática central, y el diseño de la identidad visual.', maxInscriptions: 4, currentInscriptions: 0 },
        ...
        { id: 5, name: 'Plataforma de datos', image: 'Plataforma de datos.png', description: 'Realizaremos una herramienta de gestión capitular, además se trabajarán con los datos que se tienen actualmente, para ayudar a la toma de decisiones de los líderes y juntas.', maxInscriptions: 10, currentInscriptions: 0 },
    ...
    const committees = [
        ...
        { id: 4, name: 'Integraciones', image: 'Integraciones.png', description: 'Planear y ejecutar 2 integraciones: 1 integración capitular para asociados (estudiantes) y 1 integración para egresados.', maxInscriptions: 6, currentInscriptions: 0 },
        { id: 5, name: 'Investigación de mercados', image: 'Investigacion de mercados.png', description: 'Se definirán estrategias y planes de acción, además se realizarán gráficos en Looker Studio que sirvan como informes para las siguientes Juntas Directivas.', maxInscriptions: 6, currentInscriptions: 0 },
        { id: 6, name: 'Posicionamiento y bienestar', image: 'Posicionamiento y bienestar.png', description: 'Se diseñarán y ejecutarán actividades presenciales orientadas a posicionar la marca y fortalecer el trabajo en equipo, con un enfoque especial en actividades deportivas. Además, se promoverá el bienestar por medio de actividades que fomenten la amistad y el compañerismo entre los asociados.', maxInscriptions: 6, currentInscriptions: 0 },
        { id: 7, name: 'Premios MAX', image: 'Premios MAX.png', description: 'Planear y ejecutar los Premios MAX, un evento en donde se resalten las cualidades y el excelente trabajo de los asociados del capítulo en base en su trabajo y desempeño.', maxInscriptions: 10, currentInscriptions: 0 },
        ...
        { id: 9, name: 'Visitas industriales', image: 'Visitas industriales.png', description: 'Coordinar, planear y ejecutar visitas industriales para los asociados con el fin de proporcionarles una experiencia práctica y directa sobre los procesos, tecnologías y operaciones en diferentes sectores industriales.', maxInscriptions: 7, currentInscriptions: 0 }
    ];
