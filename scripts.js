document.addEventListener('DOMContentLoaded', function () {
    const projects = [
        { id: 9, name: 'ANEIAP Informa', image: 'ANEIAP informa.png', description: 'Las 3 ediciones del periódico capitular del semestre que se compartirá por el correo.', maxInscriptions: 0, currentInscriptions: 0 },
        ...
        { id: 7, name: 'FRAC', image: 'FRAC.png', description: 'La planeación, logística, presupuesto, realización y ejecución del FRAC.', maxInscriptions: 3, currentInscriptions: 0 },
        { id: 8, name: 'Green team', image: 'Green team.png', description: 'Realizaremos al menos 2 espacios: 1 de responsabilidad ambiental y otro de responsabilidad social.', maxInscriptions: 2, currentInscriptions: 0 },
        { id: 6, name: 'Lingua estrangeira', image: 'Lingua estrangeira.png', description: 'Se realizará al menos 1 espacio de inmersión en cultura y lengua extranjera enfocados en temáticas de las ingenierías Administrativa e Industrial.', maxInscriptions: 2, currentInscriptions: 0 },
        ...
        { id: 10, name: 'Mentes de halcón', image: 'Mentes de halcon.png', description: 'Los asociados se capacitarán sobre los EEFF de ANEIAP, aprenderán acerca del manejo de los formatos financieros, tendrán el acceso a los movimientos contables y realizarán exposiciones e informe sobre la situación financiera del capítulo. Además tendrán acceso a cursos financieros de Coursera.', maxInscriptions: 0, currentInscriptions: 0 },
        { id: 3, name: 'Programa de insignias', image: 'Programa de insignias.png', description: 'Ejecutaremos el plan de incentivos por medio de la creación de insignias físicas o virtuales que fomenten la participación de los Asociados.', maxInscriptions: 5, currentInscriptions: 0 },
